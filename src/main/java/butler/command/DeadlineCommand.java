...
public class DeadlineCommand extends Command {
    ...
    /**
     * Constructs a DeadlineCommand object that executes a specified command.
     *
     ...
     * In this case it adds a Deadline to the taskList and stores the updated list in a file.
